...
public:
    ...
    // Método para mostrar datos auténticos del cliente (heredado de la clase base)
    using Cliente::mostrarDatos;
};
...
int main() {
    ...
    // Muestra los datos originales del cliente (a través de la herencia protegida)
